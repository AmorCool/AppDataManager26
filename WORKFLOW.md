...
|------|------|--------|---------|
| **AppData Manager** | repository root | ✅ Stable | 1.6.4 |
...
| **1.6.4** | **2026-08-17** | **AppData Manager: consistent backups, cross-app restore protection, serialized backup deletion, and Sileo dev sync** |
